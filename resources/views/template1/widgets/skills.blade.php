...
<section id="skills" class="skills section">
    ...
    <h2>Skills</h2>
    <p>These aren't all my skills—just the ones that fit without crashing the layout. 😄</p>
    ...
    <div class="row">
        ...
        <div class="skills-category" data-aos="fade-up" data-aos-delay="300">
            ...
            <div class="skill-item">
                ...
                <div class="skill-tooltip">Full-stack development with Laravel framework</div>
            </div>
